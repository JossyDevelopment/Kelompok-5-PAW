                ...
                <form action="{{ route('login') }}" method="POST">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="grid grid-cols-3 gap-3">
                            ...
                            <div class="border border-gray-200 rounded-lg p-3 text-center opacity-60 hover:opacity-100 cursor-pointer transition">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="username" class="pl-10 w-full border border-gray-300 rounded-lg p-2.5 focus:ring-blue-500 focus:border-blue-500 text-sm" placeholder="nama@email.com" required value="{{ old('username') }}">
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <a href="{{ route('password.request') }}" class="text-sm text-blue-600 hover:underline font-medium">Lupa password?</a>
                    </div>
